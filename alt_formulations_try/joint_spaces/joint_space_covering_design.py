if __name__ == '__main__':
    ...
    designer_1.criterion = MaximalCovering
    designer_1.n_runs = 4
    ...
    fig.tight_layout()
    fig.savefig("joint_space_covering_design.png", dpi=160)
    ...
    designer_2.criterion = MaximalCovering
    designer_2.n_runs = 4
    ...
    designer_3.criterion = MaximalCovering
    designer_3.n_runs = 4
    ...
    objs = np.array([
        # from biobj_results/date_2022_10_21/biobj_input_covering_output_covering_11x11_grid_4_runs_10_paretos
        [1.265, 0.450],
        [0.894, 0.505],
        [0.825, 0.578],
        [0.721, 0.651],
    ...
    axes.set_xlabel("Maximal Input Covering (lower is better)")
    axes.set_ylabel("Maximal Output Covering (lower is better)")
    fig.tight_layout()
    fig.savefig("pareto_with_joint_covering_design.png", dpi=180)
